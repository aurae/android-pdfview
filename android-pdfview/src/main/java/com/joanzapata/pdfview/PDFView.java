...
public class PDFView extends SurfaceView {
	...
	/** True if the PDF in question doesn't have uniform dimensions for all its pages */
	private boolean useChangingPageDimensions;
	...
	public void useChangingPageDimensions(boolean useChangingPageDimensions) {
		this.useChangingPageDimensions = useChangingPageDimensions;
	}
	...
	private void setupPageDimensions(int pageIndex) {
		this.pageWidth = decodeService.getPageWidth(pageIndex);
		this.pageHeight = decodeService.getPageHeight(pageIndex);
		calculateOptimalWidthAndHeight();
	}
	...
	public class Configurator {
		...
		private boolean useChangingPageDimensions = false;
		...
		public Configurator useChangingPageDimensions(boolean value) {
			this.useChangingPageDimensions = value;
			return this;
		}
		...
		public void load() {
			...
			PDFView.this.useChangingPageDimensions(useChangingPageDimensions);
